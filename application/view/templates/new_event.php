...
<form method="POST" class="form-horizontal">
	...
	<div class="form-group form-group-lg">
    	...
    	<div class="col-sm-10">
      		<input type="text" class="form-control" name="name_event" placeholder="Новое событие в нашей жизни">
    	</div>
  	</div>
  	<!-- Полное описание -->
    ...
    <div class="form-group form-group-sm">
  	...
  	<div class="form-group">
    	<div class="col-sm-offset-2 col-sm-4">
      		<button type="submit" class="btn btn btn-primary btn-block" name="add">Создать событие</button>
    	</div>
  	</div>
</form>
